    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">AdriSu Kids</p>
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-xs text-gray-400">o continua con email</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-gray-100 rounded-2xl p-6 space-y-4 shadow-sm">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-300" placeholder="••••••••" />
          </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">No tienes cuenta? <Link href="/registro" className="text-green-600 font-medium">Registrate</Link></p>
        <p className="text-center text-xs text-gray-400 mt-4">Tambien puedes <Link href="/checkout" className="text-green-600 font-medium">comprar sin cuenta</Link></p>
      </div>
    </div>
  );
}
...
export default function LoginPage() {
  return <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin text-green-500" size={32} /></div>}><LoginForm /></Suspense>;
}
